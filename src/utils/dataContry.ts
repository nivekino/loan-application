...
const municipios: { [key: string]: { label: string; value: string }[] } = {
  Ahuachapán: [
    ...
    { label: "San Pedro Pajonal", value: "San Pedro Pajonal" },
  ...
  Santa_Ana: [
    ...
    { label: "San Sebastián Salitrillo", value: "San Sebastián Salitrillo" },
    { label: "Santa Ana", value: "Santa Ana" },
    { label: "Santa Rosa Guachipilín", value: "Santa Rosa Guachipilín" },
    { label: "Santiago de la Frontera", value: "Santiago_de_la_Frontera" },
